...
public class AESObfuscator implements Obfuscator {
    ...
    public String obfuscate(String original, String key) {
        ...
        try {
            ...
            return Base64.encode(encryptor.doFinal((header + key + original).getBytes(StandardCharsets.UTF_8)));
        } catch (GeneralSecurityException e) {
            throw new RuntimeException("Invalid environment", e);
        }
    }
    ...
    public String unobfuscate(String obfuscated, String key) throws ValidationException {
        ...
        try {
            ...
            String result = new String(decryptor.doFinal(Base64.decode(obfuscated)), StandardCharsets.UTF_8);
